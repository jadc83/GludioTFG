                ...
                <div className="flex h-16 items-center justify-between">
                    ...
                    <div className="flex items-center space-x-4 flex-1 justify-end">
                                ...
                                {openUserMenu && (
                                    <div className="absolute right-0 z-50 mt-2 w-48 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5">
                                        <div className="py-1">
                                            ...
                                            <Link method="post" href={route('logout')} as="button" className="block w-full px-4 py-2 text-left text-sm text-gray-700 hover:bg-gray-50">
                                                Cerrar sesión
                                            </Link>
                                        </div>
                                    </div>
                        ...
                        <div className="flex sm:hidden">
                            <button onClick={() => setAbrir(!AbrirDesplegable)}
            ...
            >
                ...
                <div className="border-t border-red-600 px-4 py-4">
                    {user ? (
                        ...
                        <>
                            <ResponsiveNavLink href={route('login')} className="block rounded px-3 py-2 text-black hover:bg-red-600">
                                Log in
                            </ResponsiveNavLink>
