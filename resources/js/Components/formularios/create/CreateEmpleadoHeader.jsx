...
export default function CreateEmpleadoHeader({ onCerrar }) {
    return (
        <header className="flex flex-none items-center justify-between border-b border-gray-100 bg-white p-6">
            <div>
                ...
                <p className="mt-1 text-[10px] font-bold uppercase tracking-widest text-gray-400">Gestión de Personal</p>
            </div>
            <button
                onClick={onCerrar}
