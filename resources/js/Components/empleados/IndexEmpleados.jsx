                                ...
                                <tbody className="divide-y divide-gray-50">
                                    {empleadosPaginados.map((e) => (
                                        ...
                                        >
                                            ...
                                            <td className="px-6 py-4 text-sm font-bold uppercase tracking-tight text-gray-700">
                                                {e.departamento || '—'}
                                            </td>
                                            <td className="px-6 py-4 text-[11px] text-sm font-bold uppercase text-gray-600">
                                                {e.puesto || '—'}
                                            </td>
