...
export default function ModalConfirmacionReserva({ reserva, isOpen, onClose }) {
    ...
    return (
        <>
            ...
            {/* Modal */}
            <div className={`modal-wrapper ${animarSalida ? 'scale-95 opacity-0' : 'scale-100 opacity-100' } text-sm flex flex-col items-center justify-center bg-gris rounded-lg`} style={{maxWidth:'360px', margin:'0 auto'}}>

                {/* Header */}
                <div className="px-4 py-3 bg-gris w-full text-center">
                ...
                <div className="flex-1 overflow-y-auto px-4 py-3 space-y-3 w-full">
                    ...
                    <div className="bg-gris border border-gray-200 rounded-lg p-2 text-center">
                ...
                {/* Footer */}
                <div className="px-3 py-2 bg-gris w-full text-center">
