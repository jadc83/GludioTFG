    ...
    return (
        <section className="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm">
            <div className="border-b border-gray-100 bg-[#7a0202] px-6 py-4">
                <h3 className="text-xs font-bold uppercase tracking-widest text-white">Habitaciones asignadas</h3>
            </div>
            ...
            <div className="divide-y divide-gray-100">
                {habitaciones.map((hab, idx) => (
                    <div
                        ...
                        className="flex items-center justify-between p-6 transition hover:bg-[#7a0202]/6"
                    >
                        <div>
                            ...
                            <div className="flex flex-col items-end gap-2 text-right">
                                <div className="flex items-center gap-2">
                                    <span className="inline-flex items-center rounded-md bg-black px-3 py-1 text-xs font-bold text-white">
                                        <svg className="w-3 h-3 mr-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M5 13l4 4L19 7" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>
                                        Asignada
                                    </span>
