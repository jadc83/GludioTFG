                                ...
                                {calendarioAbierto === 'entrada' && (
                                    <>
                                        ...
                                        {isMobile ? (
                                            ...
                                            <div ref={calendarioRef} className="fixed bg-white rounded-xl shadow-2xl p-0 w-full max-w-[40rem] mx-4 z-50 left-1/2 -translate-x-1/2 calendar-pos-1366" data-calendario>
