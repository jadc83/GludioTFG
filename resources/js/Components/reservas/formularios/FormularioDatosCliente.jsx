...
export default function FormularioDatosCliente({ form, errores, onChange, onNext, hideDates = false, hideNextButton = false}) {
    ...
    return (
        <form onSubmit={onNext} className="h-full flex flex-col p-2 text-sm">
            ...
            <div className="flex-1 overflow-y-auto space-y-4">
                ...
                <div className="mt-2 text-xs text-gray-700">
                    ...
                    <p className="mt-1 text-xs text-gray-600">
                        Le deseamos una fantástica estancia con nosotros y quedamos a su disposición para cualquier consulta.
                    </p>
                </div>
