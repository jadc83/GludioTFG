...
export default function ModalReembolso({
    ...
    return (
        <div className="fixed inset-0 z-[110] flex items-center justify-center bg-black/60 p-4 backdrop-blur-sm">
            <div className="animate-in fade-in slide-in-from-bottom-4 w-full max-w-md rounded-3xl bg-white shadow-2xl duration-300 overflow-hidden">
                <div className="bg-[#7a0202] p-6">
                    <h2 className="text-lg font-black uppercase tracking-tight text-white">Solicitar Reembolso</h2>
                </div>
                {procesando ? (
