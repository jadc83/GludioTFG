...
export default function ModalPago({
    ...
    return (
        ...
        >
            <div
                className="animate-in zoom-in w-full max-w-md rounded-3xl bg-white p-8 shadow-2xl duration-200"
                role="document"
            >
                <div className="mb-8 flex items-start justify-between">
                    <div>
                        <h2
                            id="modal-pago-title"
                            className="text-2xl font-black uppercase leading-tight text-gray-900"
                        >
                            Pago Adicional
                        </h2>
                        <p className="mt-1 text-sm font-medium text-gray-400">
                            Se requiere saldar la diferencia para aplicar
                            cambios.
                        </p>
                    </div>
                    <button
                ...
                <div className="mt-6 space-y-3">
                    <button
                        onClick={onCerrar}
                        className="w-full py-4 text-[10px] font-bold uppercase tracking-widest text-gray-400 transition hover:text-gray-600"
                    >
                        Cancelar operación
                    </button>
                </div>
