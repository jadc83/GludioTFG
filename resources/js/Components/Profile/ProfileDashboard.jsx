...
export default function ProfileDashboard({ empleado = null, habitaciones = [] }) {
                    ...
                    <div className="rounded-xl border border-gray-100 p-4 bg-white">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <div className="text-xs text-gray-500">{empleado?.departamento || ''}</div>
                                <div className="mt-2 text-xs text-gray-600">Rol: <span className="font-semibold">{empleado?.role || (empleado?.roles && empleado.roles[0]) || 'Empleado'}</span></div>
                            </div>
                            <div>
