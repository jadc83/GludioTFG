        ...
        <section className="overflow-hidden bg-gris py-12 md:py-16">
            <div className="container mx-auto px-6 lg:px-12">
                ...
                <div className="w-full">
                    <Splide options={{ type: 'loop', perPage: 4, perMove: 1, gap: '1rem', arrows: true, pagination: false, autoplay: true, interval: 3500, pauseOnHover: true, breakpoints: { 1024: { perPage: 3 }, 768: { perPage: 2 }, 480: { perPage: 1 } } }} className="pb-8 pt-2">
                        {[
                            { src: '/spa.png', alt: 'Spa y bienestar', descripcion: 'Masajes que te harán olvidar hasta tu nombre' },
                            { src: '/spa2.jpg', alt: 'Spa y bienestar', descripcion: 'Masajes que te harán olvidar hasta tu nombre' },
                            ...
                            <SplideSlide key={index}>
                                <div className="group relative h-[400px] cursor-pointer overflow-hidden rounded-2xl shadow-lg transition-transform duration-500 hover:scale-[1.02] hover:shadow-2xl md:h-[480px]">
                                    <img className="h-full w-full object-cover transition-transform duration-700 group-hover:scale-110" src={imagen.src} alt={imagen.alt} />
                                    ...
                                    <div className="absolute bottom-0 left-0 right-0 p-6">
                                        <h3 className="mb-2 text-2xl font-bold text-white">{imagen.alt}</h3>
                                        <p className="translate-y-4 text-sm text-white/80 opacity-0 transition-all duration-500 group-hover:translate-y-0 group-hover:opacity-100">{imagen.descripcion}</p>
