...
export function useCookies() {
    ...
    const hasAcceptedAnalytics = useCallback(
        () => getCookieConsent().analytics === true,
        [getCookieConsent],
    );
    const hasAcceptedMarketing = useCallback(
        () => getCookieConsent().marketing === true,
        [getCookieConsent],
    );
    const hasAcceptedPreferences = useCallback(
        () => getCookieConsent().preferences === true,
        [getCookieConsent],
    );
